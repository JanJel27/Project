import pygame,sys,gameover,lvl_main,vic,mysql.connector
from pygame.locals import*
from button import *
from lvl_main import *
from jump_fun import *
import sqlite3
...
def run():
    ...
    star_image=pygame.transform.scale(pygame.image.load('image/star10.png'),(12,12))
    ...
    pygame.mixer.music.load('music/theme_1.mp3')
    ...
    #enemies
    #enemy1 = EnemyAnimation(enemy_img1, 250, 115, 50, 270)
    ...
    enemy_rect = pygame.Rect(250,104,22,30)
    enemy_rect2 = pygame.Rect(980,104,22,30)
    enemy_rect3 = pygame.Rect(2000,104,22,30)
    
    

    #treasure chest
    chest_rect = pygame.Rect(2629, 138, 25,22)
    ...
    #background_objects = [[0.25,[170,141,122,50]],[0.25,[280,30,40,400]],[0.5,[30,40,40,400]],[0.5,[130,90,40,400]]]
    ...
    while True: # game loop
        ...
        enemy_rect, ecollisions = enemy_move(enemy_rect, enemy_movement1, tile_rects)
        ...
        #display.blit(animation_frames, (player_rect.x - scroll[0], player_rect.y - scroll[1]))
        #player_img_display
        display.blit(pygame.transform.flip(player_img,player_flip,False),(player_rect.x-scroll[0],player_rect.y-scroll[1]))
        #enemies display
        display.blit(pygame.transform.flip(enemy_img,enemy_flip1,False),(enemy_rect.x-scroll[0],enemy_rect.y-scroll[1]))
